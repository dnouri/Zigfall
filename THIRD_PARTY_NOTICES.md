...
| Trystero / @trystero-p2p | Vendored browser-only WebRTC transport bundle for future web online play | MIT | Copyright (c) 2021 Dan Motzenbecker. Includes local Zigfall receive allowlist and pending-buffer cap patches documented in `web/vendor/README.md`. |
